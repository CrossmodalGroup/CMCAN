...
def encode_data(model, data_loader, log_step=10, logging=print):
    ...
    max_n_word = 0
    for i, (images, captions, lengths, adjs, depends, ids) in enumerate(data_loader):
    ...
    return img_embs, cap_embs, cap_lens, all_adjs, all_depends
...
def evalrank(model_path, data_path=None, split='dev', fold5=False):
    ...
    vocab = deserialize_vocab('/ssd1/zht/DATA/vocab/%s_vocab.json' % opt.data_name)
    ...
    img_embs, cap_embs, cap_lens, adjs, depends = encode_data(model, data_loader)
...
def shard_attn_scores(model, img_embs, cap_embs, cap_lens, adjs, depends, opt, shard_size=100):
    ...
    for i in range(n_im_shard):
        ...
        for j in range(n_cap_shard):
            ...
            with torch.no_grad():
                ...
                sim = model.forward_sim(im, ca, l, adj, dep)
...
if __name__ == '__main__':
    evalrank("./models/checkpoint_f30k_c499.3.pth.tar",
